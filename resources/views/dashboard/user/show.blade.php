                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-footer bg-whitesmoke text-right">
                                ...
                                <a href="{{ route('user.edit', $user->slug) }}" class="btn btn-warning">Edit Data</a>
                                <a href="{{ route('user.destroy', $user->slug) }}" class="btn btn-danger" data-confirm-delete="true">Hapus Data</a>
                            </div>
                        </div>
                    </div>
                </div>
