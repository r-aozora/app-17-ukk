                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-footer bg-whitesmoke text-right">
                                ...
                                <a href="{{ route('buku.edit', $buku->slug) }}" class="btn btn-warning">Edit Data</a>
                                <a href="{{ route('buku.destroy', $buku->slug) }}" class="btn btn-danger" data-confirm-delete="true">Hapus Data</a>
                            </div>
                        </div>
                    </div>
                </div>
